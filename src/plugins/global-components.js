...
const remixIcons = [
  ...
  { name: "ri-image-circle", component: RiImageCircleFill },
  { name: "ri-close-circle", component: RiCloseCircleLine },
];
...
export default {
  install: (app) => {
    ...
    app.component(
      "brand-logo",
      require("@/components/custom/logo/BrandLogo").default
    );
    app.component(
      "brand-name",
      require("@/components/custom/logo/BrandName").default
    );
    app.component(
      "in-content-laoder",
      require("@/components/custom/loader/InContentLoaderComponent.vue").default
    ),
